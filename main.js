                    ...
                    float glowFactor = 0.;
                     ...
                     if (l <= r * r) {
                        for (int side = 0; side <= 1; side++) {
                            ...
                            float nlat = (lat + 1.57) / 3.14;
                            float nlon = (lon + 3.14) / 6.28;
                            
                            float land = 0.0;
                            
                            // Africa
                            if (nlat > 0.25 && nlat < 0.75 && nlon > 0.45 && nlon < 0.65) {
                                land = 0.8;
                            }
                            // Asia
                            else if (nlat > 0.5 && nlat < 0.85 && nlon > 0.65 && nlon < 0.95) {
                                land = 0.7;
                            }
                            // Europe
                            else if (nlat > 0.65 && nlat < 0.8 && nlon > 0.4 && nlon < 0.6) {
                                land = 0.6;
                            }
                            // North America
                            else if (nlat > 0.5 && nlat < 0.8 && nlon > 0.1 && nlon < 0.35) {
                                land = 0.7;
                            }
                            // South America
                            else if (nlat > 0.2 && nlat < 0.5 && nlon > 0.15 && nlon < 0.35) {
                                land = 0.6;
                            }
                            // Australia
                            else if (nlat > 0.15 && nlat < 0.35 && nlon > 0.8 && nlon < 0.95) {
                                land = 0.5;
                            }
                            
                            float noise = sin(lon * 25.0) * cos(lat * 30.0) * 0.05;
                            land += noise;
                            
                            float mapColor = max(land, 0.1);
